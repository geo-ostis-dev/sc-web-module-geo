...
if [[ -d $scweb_folder/client/static/components/sc-web.module.geo ]]; then
  puts "The sc-web project already has a geo module installed, remove it before installing a new one" red
  exit 0 
fi
