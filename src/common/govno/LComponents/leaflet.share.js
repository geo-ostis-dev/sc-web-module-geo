L.OSM.share = function (options) {
  ...
  control.onAdd = function (map) {
    ...
    var button = $('<a>')
      ...
      .attr('href', '#')
      .attr('title', 'javascripts.share.title')
    ...
    $('<div>')
      ...
      .append(
        $('<span>')
          .text('javascripts.close')
          .attr('class', 'icon close')
          .bind('click', toggle))
      .append(
        $('<h4>')
          .text('javascripts.share.title'));
    ...
    $('<div>')
      ...
      .append(
        $('<label>')
          ...
          .append('javascripts.share.include_marker'));
    ...
    $('<div>')
      ...
      .append($('<a>')
        ...
        .attr('for', 'long_input')
        .attr('id', 'long_link')
        .text('javascripts.share.long_link'))
      .append($('<a>')
        .attr('for', 'short_input')
        .attr('id', 'short_link')
        .text('javascripts.share.short_link'))
      .append($('<a>')
        .attr('for', 'embed_html')
        .attr('href', '#')
        .text('javascripts.share.embed'))
    ...
    $('<div>')
      ...
      .append(
        $('<p>')
          ...
          .text('javascripts.share.paste_html')
          .appendTo($linkSection));
    ...
    $('<h4>')
      .text('javascripts.share.geo_uri')
    ...
    $('<h4>')
      .text('javascripts.share.image')
      .appendTo($imageSection);

    $('<div>')
      .attr('id', 'export-warning')
      .attr('class', 'deemphasize')
      .text('javascripts.share.only_standard_layer')
      .appendTo($imageSection);
    ...
    $('<div>')
      ...
      .append(
        $('<label>')
          ...
          .append('javascripts.share.custom_dimensions'));
    ...
    $('<p>')
      .attr('class', 'deemphasize')
      .html('javascripts.share.image_size' + ' <span id="mapnik_image_width"></span> x <span id="mapnik_image_height"></span>')
      .appendTo($form);

    $('<input>')
      .attr('type', 'submit')
      .attr('value', 'javascripts.share.download')
      .appendTo($form);
    ...
    function update() {
      ...
      $('#embed_html').val(
        '<iframe width="425" height="350" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="' +
          escapeHTML(MAP.SERVER_PROTOCOL + '://' + MAP.SERVER_URL + '/export/embed.html?' + $.param(params)) +
          '" style="border: 1px solid black"></iframe><br/>' +
          '<small><a href="' + escapeHTML(map.getUrl(marker)) + '">' +
          escapeHTML('javascripts.share.view_larger_map') + '</a></small>');
