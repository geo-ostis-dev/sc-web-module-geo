export default function initializeContextMenu(map) {
  map.contextmenu.addItem({
    text: "javascripts.context.directions_from",
  ...
  map.contextmenu.addItem({
    text: "javascripts.context.directions_to",
  ...
  map.contextmenu.addItem({
    text: "javascripts.context.add_note",
  ...
  map.contextmenu.addItem({
    text: "javascripts.context.show_address",
  ...
  map.contextmenu.addItem({
    text: "javascripts.context.query_features",
  ...
  map.contextmenu.addItem({
    text: "javascripts.context.centre_map",
