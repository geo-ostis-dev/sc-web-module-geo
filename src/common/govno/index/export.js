OSM.Export = function(map) {
  ...
  function validateControls() {
    $("#export_osm_too_large").toggle(getBounds().getSize() > MAP.MAX_REQUEST_AREA);
    $("#export_commit").toggle(getBounds().getSize() < MAP.MAX_REQUEST_AREA);
  }

  function checkSubmit(e) {
    if (getBounds().getSize() > MAP.MAX_REQUEST_AREA) e.preventDefault();
  }
